...
```bash
choco install anki bruno chocolateygui chezmoi discord es everything git gitkraken gnucash jetbrainstoolbox microsoft-windows-terminal powertoys sysinternals tailscale virtualbox vivaldi wiztree
```
